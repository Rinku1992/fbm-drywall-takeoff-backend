...
async def floorplan_to_structured_2d_sectioned(
    ...
    if model and predict:
        ...
        walls_2d_layout, polygons_layout, external_contour = layout_2d["walls_2d"], layout_2d["polygons"], layout_2d["metadata"]["contour_root_vertices"]
...
async def floorplan_section_to_structured_2d(request: Request):
    ...
    is_scale_detected = await floorplan_to_structured_2d_sectioned(
        CREDENTIALS,
        pg_pool,
        session_uuid,
        floor_plan_modeller_2d,
