...
class FloorPlan2D(FloorPlan):
    ...
    def _add_walls_polygon_given_preselection(
        ...
        polygon_preselected["polygon_drywall"]["type_stacked"] = predict_polygon["ceiling"].get("drywall_assembly", dict()).get("materials_vertically_stacked", list()) if polygon_preselected["polygon_drywall"]["type_stacked"] == [] else polygon_preselected["polygon_drywall"]["type_stacked"]
        polygon_preselected["polygon_drywall"]["color_stacked"] = predict_polygon["ceiling"].get("drywall_assembly", dict()).get("color_codes_stacked", list()) if polygon_preselected["polygon_drywall"]["color_stacked"] == [] else polygon_preselected["polygon_drywall"]["color_stacked"]
