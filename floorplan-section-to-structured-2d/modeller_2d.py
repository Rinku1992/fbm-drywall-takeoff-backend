...
class FloorPlan2D(FloorPlan):
            ...
            if wall_payload:
                ...
                wall_payload["polygons_drywall"].append(
                    dict(
                        ...
                        height_stacked=wall_parameter["drywall_assembly"]["heights_stacked"],
                        thickness=thickness,
    ...
    def _add_drywalls_polygon(
        ...
        for index, drywall_index in enumerate(polygon["polygon_ids_drywall_interior"]):
            ...
            polygon_drywall["height_stacked"]=predict_polygon["wall_parameters"][index]["drywall_assembly"]["heights_stacked"],
