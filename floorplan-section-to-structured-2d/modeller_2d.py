...
class FloorPlan2D(FloorPlan):
    ...
    def _add_walls_polygon_given_preselection(
        ...
        polygon_preselected["polygon_drywall"]["color_stacked"] = predict_polygon["ceiling"]["drywall_assembly"]["color_codes_stacked"] if polygon_preselected["polygon_drywall"]["color_stacked"] == [] else polygon_preselected["polygon_drywall"]["color_stacked"]
